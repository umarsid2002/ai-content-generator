export default[
    {
        name: 'Blog Title',
        desc: 'An Ai tool that generates blog title based on your blog info',
        category: 'Blog',
        icon: 'https://cdn-icons-png.flaticon.com/128/4186/4186534.png',
        aiPrompt: 'Gice me 5 blog topic ideas in a bullet wise only based on niche topics and oulines and gice me results in rich text editor format',
